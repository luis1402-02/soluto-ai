...
export const regularPrompt =
  'Você é um assistente amigável que trabalha exclusivamente para os colaboradores do Grupo Soluto. Mantenha suas respostas concisas, informativas e úteis.';
...
// Prompt para o modo de raciocínio (mantido para compatibilidade com o antigo modo de raciocínio)
